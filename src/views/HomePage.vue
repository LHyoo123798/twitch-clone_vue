  ...
  <div class="demo">
    <div v-if="tableData.length>0" >
      <el-carousel :interval="0" :type="carouselType" height="280px" width="500px" indicator-position="none" arrow="always">
        <el-carousel-item v-for="item in 6" :key="tableData[item-1].roomId">
          <div style="height: 100%;width: 100%;display: flex;align-items: center">
            <div style="width: 70%;height: 100%" @click="navigateToRoute('/live', tableData[item-1])">
            ...
            <div style="width: 30%;height: 100%">
              ...
              <div style="width: 100%;height: 18%;font-size: 15px"><b>{{tableData[item-1].roomName}}</b></div>
              <div style="width: 100%;height: 18%"><el-tag size="medium " type="warning"><b>{{tableData[item-1].classification}}</b></el-tag></div>
              <div style="width: 100%;height: 18%">
                <i class="el-icon-user" style="margin-right: 10px"></i><b>{{tableData[item-1].fans}}</b>
              </div>
            </div>
          </div>
        </el-carousel-item>
        ...
        <ul class="infinite-list" v-infinite-scroll="load" infinite-scroll-disabled="disabled">
          <li v-for="i in count" :key="i" class="infinite-list-item" style="list-style-type:none">
            <div class="div-container">
              <div style="height: 320px;width: 100px" v-for="index in 3" :key="tableData[i * 3 - 3 + index - 1].roomId" class="inner-div" @click="navigateToRoute('/live', tableData[i * 3 - 3 + index - 1])">
                <div style="height: 80%;width: 100%" >
                  <el-image src="https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg"></el-image>
                </div>
                <div style="height: 20%;width: 100%;display: flex;align-items: center;justify-content: space-between;">
